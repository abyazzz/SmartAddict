...
QUESTIONS = [
    ...
    {"key": "daily_screen_time_hours", "label": "Berapa jam total screen time per hari?", "description": "Total waktu menatap layar smartphone. Rentang: 0-24 jam.", "min": 0, "max": 24, "step": 0.1, "default": 5},
    {"key": "social_media_hours", "label": "Berapa jam menggunakan media sosial per hari?", "description": "Instagram, TikTok, Twitter, dll. Rentang: 0-24 jam.", "min": 0, "max": 24, "step": 0.1, "default": 2},
    {"key": "gaming_hours", "label": "Berapa jam bermain game per hari?", "description": "Mobile game, console, dll. Rentang: 0-24 jam.", "min": 0, "max": 24, "step": 0.1, "default": 1},
    {"key": "sleep_hours", "label": "Berapa jam tidur Anda per hari?", "description": "Rata-rata jam tidur per malam. Rentang: 0-12 jam.", "min": 0, "max": 12, "step": 0.1, "default": 7},
    ...
    {"key": "weekend_screen_time", "label": "Berapa jam screen time saat weekend?", "description": "Total screen time di hari Sabtu/Minggu. Rentang: 0-24 jam.", "min": 0, "max": 24, "step": 0.1, "default": 6},
]
            ...
            if file and file.filename.endswith('.csv'):
                try:
                    ...
                    if num_cols == 10:
                        ...
                        errors.append(f"CSV harus memiliki 9 kolom fitur (ditemukan {num_cols} kolom).")
                    if not errors:
                        if len(df) == 0:
